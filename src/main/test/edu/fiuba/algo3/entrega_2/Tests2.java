...
public class Tests2 {
    ...
    public void test16LaConversionDelJsonMapaEsLaIndicada()
    {
        ...
        Parcela[][] filasMapa = {
            {new Rocoso(0,0),new Pasarela(1,0),new Tierra(2,0),new Tierra(3,0),new Tierra(4,0),new Tierra(new Posicion(5,0)),new Tierra(new Posicion(6,0)),new Tierra(new Posicion(7,0)),new Tierra(new Posicion(8,0)),new Tierra(new Posicion(9,0)),new Rocoso(new Posicion(10,0)),new Rocoso(new Posicion(11,0)),new Rocoso(new Posicion(12,0)),new Rocoso(new Posicion(13,0)),new Rocoso(new Posicion(14,0))},
            {new Tierra(0,1),new Pasarela(1,1),new Tierra(2,1),new Tierra(3,1),new Tierra(4,1),new Tierra(new Posicion(5,1)),new Tierra(new Posicion(6,1)),new Tierra(new Posicion(7,1)),new Tierra(new Posicion(8,1)),new Tierra(new Posicion(9,1)),new Rocoso(new Posicion(10,1)),new Rocoso(new Posicion(11,1)),new Rocoso(new Posicion(12,1)),new Rocoso(new Posicion(13,1)),new Rocoso(new Posicion(14,1))},
            {new Tierra(0,2),new Pasarela(1,2),new Tierra(2,2),new Tierra(3,2),new Tierra(4,2),new Tierra(new Posicion(5,2)),new Tierra(new Posicion(6,2)),new Tierra(new Posicion(7,2)),new Tierra(new Posicion(8,2)),new Tierra(new Posicion(9,2)),new Rocoso(new Posicion(10,2)),new Rocoso(new Posicion(11,2)),new Rocoso(new Posicion(12,2)),new Rocoso(new Posicion(13,2)),new Rocoso(new Posicion(14,2))},
            {new Tierra(0,3),new Pasarela(1,3),new Tierra(2,3),new Tierra(3,3),new Tierra(4,3),new Tierra(new Posicion(5,3)),new Tierra(new Posicion(6,3)),new Tierra(new Posicion(7,3)),new Tierra(new Posicion(8,3)),new Tierra(new Posicion(9,3)),new Rocoso(new Posicion(10,3)),new Rocoso(new Posicion(11,3)),new Rocoso(new Posicion(12,3)),new Rocoso(new Posicion(13,3)),new Rocoso(new Posicion(14,3))},
            {new Tierra(0,4),new Pasarela(1,4),new Rocoso(2,4),new Rocoso(3,4),new Tierra(4,4),new Tierra(new Posicion(5,4)),new Tierra(new Posicion(6,4)),new Tierra(new Posicion(7,4)),new Tierra(new Posicion(8,4)),new Tierra(new Posicion(9,4)),new Tierra(new Posicion(10,4)),new Tierra(new Posicion(11,4)),new Tierra(new Posicion(12,4)),new Tierra(new Posicion(13,4)),new Tierra(new Posicion(14,4))},
            {new Tierra(0,5),new Pasarela(1,5),new Rocoso(2,5),new Rocoso(3,5),new Tierra(4,5),new Tierra(new Posicion(5,5)),new Tierra(new Posicion(6,5)),new Rocoso(new Posicion(7,5)),new Tierra(new Posicion(8,5)),new Tierra(new Posicion(9,5)),new Tierra(new Posicion(10,5)),new Tierra(new Posicion(11,5)),new Tierra(new Posicion(12,5)),new Tierra(new Posicion(13,5)),new Tierra(new Posicion(14,5))},
            {new Tierra(0,6),new Pasarela(1,6),new Pasarela(2,6),new Pasarela(3,6),new Pasarela(4,6),new Pasarela(new Posicion(5,6)),new Pasarela(new Posicion(6,6)),new Pasarela(new Posicion(7,6)),new Pasarela(new Posicion(8,6)),new Tierra(new Posicion(9,6)),new Tierra(new Posicion(10,6)),new Tierra(new Posicion(11,6)),new Tierra(new Posicion(12,6)),new Tierra(new Posicion(13,6)),new Tierra(new Posicion(14,6))},
            {new Tierra(0,7),new Tierra(1,7),new Tierra(2,7),new Tierra(3,7),new Tierra(4,7),new Tierra(new Posicion(5,7)),new Tierra(new Posicion(6,7)),new Tierra(new Posicion(7,7)),new Pasarela(new Posicion(8,7)),new Tierra(new Posicion(9,7)),new Tierra(new Posicion(10,7)),new Tierra(new Posicion(11,7)),new Tierra(new Posicion(12,7)),new Tierra(new Posicion(13,7)),new Tierra(new Posicion(14,7))},
            {new Tierra(0,8),new Tierra(1,8),new Tierra(2,8),new Tierra(3,8),new Tierra(4,8),new Tierra(new Posicion(5,8)),new Tierra(new Posicion(6,8)),new Tierra(new Posicion(7,8)),new Pasarela(new Posicion(8,8)),new Tierra(new Posicion(9,8)),new Tierra(new Posicion(10,8)),new Tierra(new Posicion(11,8)),new Tierra(new Posicion(12,8)),new Tierra(new Posicion(13,8)),new Tierra(new Posicion(14,8))},
            {new Tierra(0,9),new Tierra(1,9),new Tierra(2,9),new Tierra(3,9),new Tierra(4,9),new Tierra(new Posicion(5,9)),new Tierra(new Posicion(6,9)),new Tierra(new Posicion(7,9)),new Pasarela(new Posicion(8,9)),new Rocoso(new Posicion(9,9)),new Tierra(new Posicion(10,9)),new Tierra(new Posicion(11,9)),new Tierra(new Posicion(12,9)),new Tierra(new Posicion(13,9)),new Tierra(new Posicion(14,9))},
            {new Tierra(0,1)),new Tierra(1,10),new Tierra(2,10),new Tierra(3,10),new Tierra(n,10),new Tierra(new Posicion(5,10)),new Tierra(new Posicion(6,10)),new Tierra(new Posicion(7,10)),new Pasarela(new Posicion(8,10)),new Pasarela(new Posicion(9,10)),new Pasarela(new Posicion(10,10)),new Pasarela(new Posicion(11,10)),new Pasarela(new Posicion(12,10)),new Pasarela(new Posicion(13,10)),new Pasarela(new Posicion(14,10))},
            {new Rocoso(0,1)),new Rocoso(1,11),new Rocoso(2,11),new Rocoso(3,11),new Rocoso(4,11),new Tierra(new Posicion(5,11)),new Tierra(new Posicion(6,11)),new Tierra(new Posicion(7,11)),new Tierra(new Posicion(8,11)),new Tierra(new Posicion(9,11)),new Tierra(new Posicion(10,11)),new Tierra(new Posicion(11,11)),new Tierra(new Posicion(12,11)),new Tierra(new Posicion(13,11)),new Tierra(new Posicion(14,11))},
            {new Rocoso(0,1)),new Rocoso(1,12),new Rocoso(2,12),new Rocoso(3,12),new Rocoso(4,12),new Tierra(new Posicion(5,12)),new Tierra(new Posicion(6,12)),new Tierra(new Posicion(7,12)),new Tierra(new Posicion(8,12)),new Tierra(new Posicion(9,12)),new Tierra(new Posicion(10,12)),new Tierra(new Posicion(11,12)),new Tierra(new Posicion(12,12)),new Tierra(new Posicion(13,12)),new Tierra(new Posicion(14,12))},
            {new Rocoso(0,1)),new Rocoso(1,13),new Rocoso(2,13),new Rocoso(3,13),new Rocoso(4,13),new Tierra(new Posicion(5,13)),new Tierra(new Posicion(6,13)),new Tierra(new Posicion(7,13)),new Tierra(new Posicion(8,13)),new Tierra(new Posicion(9,13)),new Tierra(new Posicion(10,13)),new Tierra(new Posicion(11,13)),new Tierra(new Posicion(12,13)),new Tierra(new Posicion(13,13)),new Tierra(new Posicion(14,13))},
            {new Rocoso(0,1)),new Rocoso(1,14),new Rocoso(2,14),new Rocoso(3,14),new Rocoso(4,14),new Tierra(new Posicion(5,14)),new Tierra(new Posicion(6,14)),new Tierra(new Posicion(7,14)),new Tierra(new Posicion(8,14)),new Tierra(new Posicion(9,14)),new Tierra(new Posicion(10,14)),new Tierra(new Posicion(11,14)),new Tierra(new Posicion(12,14)),new Tierra(new Posicion(13,14)),new Tierra(new Posicion(14,14))}
            };
    ...
    public void test17ElJuegoSeCreaAcordeALosJson()
    {
        ...
        Parcela[][] filasMapa = {
            {new Rocoso(new Posicion(0,0)),new Pasarela(new Posicion(1,0)),new Tierra(new Posicion(2,0)),new Tierra(new Posicion(3,0)),new Tierra(new Posicion(4,0)),new Tierra(new Posicion(5,0)),new Tierra(new Posicion(6,0)),new Tierra(new Posicion(7,0)),new Tierra(new Posicion(8,0)),new Tierra(new Posicion(9,0)),new Rocoso(new Posicion(10,0)),new Rocoso(new Posicion(11,0)),new Rocoso(new Posicion(12,0)),new Rocoso(new Posicion(13,0)),new Rocoso(new Posicion(14,0))},
            ...
            {new Tierra(new Posicion(0,2)),new Pasarela(new Posicion(1,2)),new Tierra(new Posicion(2,2)),new Tierra(new Posicion(3,2)),new Tierra(new Posicion(4,2)),new Tierra(new Posicion(5,2)),new Tierra(new Posicion(6,2)),new Tierra(new Posicion(7,2)),new Tierra(new Posicion(8,2)),new Tierra(new Posicion(9,2)),new Rocoso(new Posicion(10,2)),new Rocoso(new Posicion(11,2)),new Rocoso(new Posicion(12,2)),new Rocoso(new Posicion(13,2)),new Rocoso(new Posicion(14,2))},
