...
public class Tests2 {
    ...
    public void test16LaConversionDelJsonMapaEsLaIndicada()
    {
        ...
        Parcela[][] filasMapa = {
            {new Rocoso(0,0),new Largada(1,0),new Tierra(2,0),new Tierra(3,0),new Tierra(4,0),new Tierra(5,0),new Tierra(6,0),new Tierra(7,0),new Tierra(8,0),new Tierra(9,0),new Rocoso(10,0),new Rocoso(11,0),new Rocoso(12,0),new Rocoso(13,0),new Rocoso(14,0)},
            ...
            {new Tierra(0,10),new Tierra(1,10),new Tierra(2,10),new Tierra(3,10),new Tierra(4,10),new Tierra(5,10),new Tierra(6,10),new Tierra(7,10),new Pasarela(8,10),new Pasarela(9,10),new Pasarela(10,10),new Pasarela(11,10),new Pasarela(12,10),new Pasarela(13,10),new Meta(14,10)},
