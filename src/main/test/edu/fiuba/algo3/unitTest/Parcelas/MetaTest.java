...
public class MetaTest {
    ...
    @Test
    public void test03AmbosMetaSonIguales()
    {
        Parcela parcela1 = new Meta(0,0);
        Parcela parcela2 = new Meta(0,0);
        assertEquals(parcela1, parcela2);
        assertEquals(parcela1, parcela1);
    }

    @Test
    public void test03AmbosMetaNoSonIguales()
    {
        Parcela parcela1 = new Meta(0,0);
        Parcela parcela2 = new Meta(1,1);
        int parcela3 = 100;
